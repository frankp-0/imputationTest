...
ln -s $base/82237/topmed-dcc/exchange/phs000974_TOPMed_WGS_Framingham/Phenotype/DCC/official/topmed_dcc_harmonized_demographic_v4_phs000974/topmed_dcc_harmonized_demographic_v4.txt sourceData/
